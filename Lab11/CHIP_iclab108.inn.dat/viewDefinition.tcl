...
create_library_set -name lib_min\
   -timing\
    ...
    ${::IMEX::libVar}/mmmc/MEM_grayscale_BC.lib]\
   -si\
...
create_library_set -name lib_max\
   -timing\
    ...
    ${::IMEX::libVar}/mmmc/MEM_grayscale_WC.lib]\
   -si\
...
create_constraint_mode -name func_mode\
   -sdc_files\
    [list /dev/null]
create_analysis_view -name av_func_mode_max -constraint_mode func_mode -delay_corner Delay_Corner_max -latency_file /RAID2/COURSE/iclab/iclab108/Lab11/05_APR/CHIP_postRoute.inn.dat/libs/mmmc/latency.sdc
create_analysis_view -name av_func_mode_min -constraint_mode func_mode -delay_corner Delay_Corner_min -latency_file /RAID2/COURSE/iclab/iclab108/Lab11/05_APR/CHIP_postRoute.inn.dat/libs/mmmc/latency.sdc
